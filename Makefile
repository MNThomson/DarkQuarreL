...
train:
	docker run -u 1000:1000 --net=host --gpus=all -e HOME=/project -it --rm -v /home/mthomson/proj/Snattle:/project -w /project tensorman:trainsnattle python3 src/train.py
